		...
		<table cellpadding="0" cellspacing="0" border="1">
			<tr>
				...
				<td width="25%" align="left">&nbsp;
					<s:select name="jffs" list="#application.vta.GetList('jffs')" listKey="id" listValue="str" value="1"></s:select>
				</td>
				<td width="25%" align="right">服务态度&nbsp;</td>
				<td width="25%" align="left">&nbsp;
					<s:radio name="manyid" list="#application.vta.GetList('manyi')" listKey="id" listValue="str" value="1"/>
				</td>
			</tr>
			<tr>
				<td align="right">客户建议&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="customjy" class="ipt100_24"/></td>
				<td align="right">外呼结果&nbsp;</td>
				<td align="left">&nbsp;
					<s:radio name="succfail" list="#application.vta.GetList('succfail')" listKey="id" listValue="str" value="1"/>
				</td>
			</tr>
			<tr>
				<td align="right">回访情况&nbsp;</td>
				<td align="left">&nbsp;
					<s:select name="hfqk" list="#application.vta.GetList('hfqk')" listKey="id" listValue="str" value="1"></s:select>	
				</td>
				<td align="right">回访姓名&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="hfname" class="ipt100_24"/></td>
			</tr>
			<tr>
				<td align="right">回访证件号&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="hfzjh" class="ipt100_24"/></td>
				<td align="right">回访二次电话&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="hfstel" class="ipt100_24"/></td>
			</tr>
			<tr>
				<td align="right">回访联系地址&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="address" class="ipt100_24"/></td>
				<td align="right">手机品牌及型号&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="phonemodel" class="ipt100_24"/></td>
			</tr>
			<tr>
				<td align="right">邮箱地址&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="email" class="ipt100_24"/></td>
				<td align="right">备注&nbsp;</td>
				<td align="left">&nbsp;<input type="text" name="remark" class="ipt100_24"/></td>
			</tr>
		</table>
	</div>
	<div class="huifanginfo2">
