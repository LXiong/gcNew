...
<div id="dbCon">
	...
	<div class="db-info">
        ...
        <div class="lab_ipt_item">
	        ...
	        <div class="ipt-box">
	        	<input type="text" id="anix" name="ani" value="${ani }" class="ipt_text_w150 inputDefault" />
	    ...
	    <div class="lab_ipt_item">
	        ...
	        <div class="ipt-box">
	        	<input type="text" id="maxwaitx" name="maxwait" value="${maxwait }" class="ipt_text_w150 inputDefault" />
	            <span class="asterisk">*</span>
	        </div>
	    </div>
